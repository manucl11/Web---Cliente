...
function mueveRana(el)
{
	...
	if (document.getElementById(id_el).src.includes("L.png")) //Get image L.png, B.png or R.png
	{
//		It is a Left Frog
...
//				alert("Moving the frog forward on a frog!")
		...
		if (document.getElementById(id_el).src.includes("R.png")) //Get image L.png, B.png or R.png
		{	
		// It's a Rigth Frog
			if(document.getElementById(id_el-1).src.includes("B.png")) 
			{
